...
// capabilities, and projects. Each ring is ordered by the average angle of its neighbors, so
// connected things sit near each other and edges cross less. Pure and dependency-free: it runs at
// build time for the no-JS view and in the browser whenever the map is resized.
