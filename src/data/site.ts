...
// Headline numbers from the resume. `ref` is an experience id or a project slug.
export const metrics: { value: string; label: string; ref: string; source: string }[] = [
  { value: '131K+', label: 'candidate directions scanned per radar frame', ref: 'solopulse', source: 'Solopulse' },
  { value: '~8×', label: 'lower per-packet signal-processing latency', ref: 'solopulse', source: 'Solopulse' },
  { value: '~50×', label: 'faster MPC solve across 4,096 parallel envs', ref: 'lidar', source: 'LIDAR Lab' },
  { value: '86%', label: 'stair success for RL-augmented MPC, vs 1% baseline', ref: 'lidar', source: 'LIDAR Lab' },
  { value: '2.5 cm', label: 'rover global position accuracy (RTK-fixed)', ref: 'robonav', source: 'RoboNav' },
  { value: '−45%', label: 'median replans on the obstacle-course suite', ref: 'robonav', source: 'RoboNav' },
  { value: '100×', label: 'faster multi-terabyte satellite preprocessing', ref: 'bdbi', source: 'Big Data Big Impact' },
  { value: '3.4 μs', label: 'overhead per GPU scope in cuCadence', ref: 'cucadence', source: 'cuCadence' },
];
